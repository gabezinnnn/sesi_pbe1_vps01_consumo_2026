...
![delete](prints/deletei.png)

- Buscar um item específico por ID:

![buscar_id](prints/buscar_por_id.png)

- Buscar um item específico pelo nome do equipamento:

![buscar_nome](prints/buscar_por_equipamento.png)

- Buscar um item específico por local:

![buscar_local](prints/buscar_por_local.png)
